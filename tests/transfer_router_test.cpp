...
int main(){
 ...
 if(fallback_volume_key(L"\\\\?\\UNC\\Server\\Share\\x")!=L"\\\\server\\share")return 25;
 if(fallback_volume_key(L"\\\\?\\Z:\\folder")!=L"z:\\")return 26;
 if(same_device({fallback_volume_key(L"\\\\?\\UNC\\A\\S\\x"),{}},{fallback_volume_key(L"\\\\?\\UNC\\B\\S\\y"),{}}))return 27;
